...
public class Lecture {
	...
	public static void main(String[] args) {
		...
		*/
		...
		int twentySeven = 27;
		diff121And27 = (oneTwentyOne - twentySeven);
		System.out.println(diff121And27);
		/*
		11. Create a double that holds the addition of 12.3 and 32.1.
		*/
		double problem11;
		double twelvePointThree = 12.3D;
		double thirtyTwoPointOne = 32.1D;
		problem11 = (twelvePointThree + thirtyTwoPointOne);
		System.out.println(problem11);
		/*
		12. Create a String that holds your full name.
		*/
		String fullName = "Ben Squier";
		...
		*/
		...
		System.out.println(oneBillion * 3);
		/*
