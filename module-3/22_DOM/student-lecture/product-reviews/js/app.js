...
function setPageTitle() {
  //Usint a variable to hold the reference to an element
...
function setPageDescription() {
  //Using dot-chaining to manipulate an element
...
function displayReviews() {
  //This requires an array and associated methods
  const main = document.getElementById('main');

  reviews.forEach(review => {
    const container = document.createElement('div');
    container.setAttribute('class', 'review');
    //KEEP ADDING PARTS OF THE REVIEW
...
function addRating(parent, numberOfStars) {
  ...
  //Create an img element for each value of review.rating
  ...
  parent.insertAdjacentElement('beforeend', ratingContainer);
}
...
function addReview(parent, review) {
  ...
  parent.insertAdjacentElement('beforeend', reviewP);
}
